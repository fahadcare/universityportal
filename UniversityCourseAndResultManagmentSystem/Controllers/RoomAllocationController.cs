...
namespace UniversityCourseAndResultManagmentSystem.Controllers
{
    public class RoomAllocationController : Controller
    {
        ...
        //public ActionResult Create([Bind(Include="RoomAllocationId,DepartmentId,CourseId,RoomId,DayId,StartTime,EndTime,Status")] RoomAllocation roomallocation)
        //{
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="RoomAllocationId,DepartmentId,CourseId,RoomId,DayId,StartTime,EndTime,Status")] RoomAllocation roomallocation)
        {
            if (ModelState.IsValid)
            {
